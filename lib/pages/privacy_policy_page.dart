              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    _buildBulletItem('设备基本信息（用于适配不同设备，不包含个人身份信息）'),
                    const SizedBox(height: 16),
                    ...
                    const SizedBox(height: 16),
                    _buildSectionTitle('八、隐私政策变更'),
                    _buildParagraph(
                      '我们可能会适时修订本隐私政策。当政策发生变更时，我们会在应用内通过弹窗或公告的方式通知您。',
                    ),
                    const SizedBox(height: 16),
